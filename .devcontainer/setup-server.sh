...
echo "--- [PROVISIONING] Constructing public URL ---"

# Determine domain GitHub Codespaces uses
if [[ -n "$CODESPACES_DEFAULT_DOMAIN" ]]; then
    DOMAIN="$CODESPACES_DEFAULT_DOMAIN"
else
    # Fallback for older orgs
    DOMAIN="app.github.dev"
fi

# Build the deterministic port URL
PUBLIC_URL="https://$CODESPACE_NAME-$SERVER_PORT.$DOMAIN"
